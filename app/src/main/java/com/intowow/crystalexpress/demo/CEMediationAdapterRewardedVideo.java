...
public class CEMediationAdapterRewardedVideo implements MediationRewardedVideoAdAdapter {
    ...
    public void initialize(Context context,
        ...
        Log.d("INTOWOWPOC", "---------- CEMediationAdapterRewardedVideo initialize");
        if (listener == null) {
        ...
        I2WAPI.init(mContext, false, true);
        mInit = true;
    }
    ...
    public void loadAd(MediationAdRequest mediationAdRequest, Bundle bundle, Bundle bundle1) {
        ...
        //
        Log.d("INTOWOWPOC", "-------------- CEMediationAdapterRewardedVideo loadAd");
        ...
        mRewardedVideoAd.setAdListener(new RewardedVideoAd.RewardedVideoAdListener() {
            ...
            public void onError(Ad ad, AdError error) {
                Log.d("INTOWOWPOC", "------------ Failed to load rewarded video ad, Error: " + (error == null ? String.valueOf(AdError.CODE_NO_FILL_ERROR) : String.valueOf(error.getErrorCode())));
