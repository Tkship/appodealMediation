...
public class CECustomEventInterstitial implements CustomEventInterstitial, InterstitialAd.InterstitialAdListener {
    ...
    public void requestInterstitialAd(Context context,
        ...
        // Error checking
        Log.d("INTOWOWPOC", "----------- CECustomEventInterstitial initialize");
    ...
    public void onError(Ad ad, AdError adError) {
        Log.d(TAG, "--------------------- C Failed to load interstitial ad, Error: " + (adError == null ? String.valueOf(AdError.CODE_NO_FILL_ERROR) : String.valueOf(adError.getErrorCode())));
        if (adError == null) {
    ...
    public void onAdLoaded(Ad ad) {
        Log.d(TAG,"-------------- D Interstitial ad loaded success");
